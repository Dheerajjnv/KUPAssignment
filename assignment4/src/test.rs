use crate::hello::repeat_finder;
use crate::palindrome::check_palindrome;
...
fn duplicate_testing_success() {
    ...
    let output = hello::repeat_finder(&word_hello);
    assert_eq!(output, "lo")
}
#[test]
...
fn pelindrom_testing_success() {
    ...
    let output = palindrome::check_palindrome(&word);
